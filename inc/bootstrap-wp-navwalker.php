...
if (! class_exists ( 'coopparty_WP_Bootstrap_Navwalker' )) :
 ...
 */
class coopparty_WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
	/**
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$output .= "\n$indent<div class=\" dropdown-menu\" role=\"menu\"><ul data-nav=\"priority\" class=\"container list-unstyled\">\n";
	}
