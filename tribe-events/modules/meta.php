...
?>
    <?php if ( $not_skeleton ) : ?>
        <div class="tribe-events-single-section tribe-events-event-meta primary border-0 mt-md-0 tribe-clearfix">
            <?php endif; ?>
                <?php
...
?>
        ...
        <?php endif; ?>
            <?php if ( $set_venue_apart ) : ?>
                <?php if ( $not_skeleton ) : ?>
                    <div class="tribe-events-single-section tribe-events-event-meta secondary widget p-2 mb-md-4 tribe-clearfix">
                        <?php endif; ?>
                            <?php
